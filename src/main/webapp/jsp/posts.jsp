...
<style>
  ...
  *{box-sizing:border-box; margin:0; padding:0;}
  ...
  <img src="${pageContext.request.contextPath}${post.imageUrl}" alt="${post.title}" style="width:100%; height:180px; object-fit:cover; border-radius:6px; margin-bottom:12px;">
  </c:if>
